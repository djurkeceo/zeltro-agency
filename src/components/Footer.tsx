      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-links">
            <h4>Navigacija</h4>
            <ul>
              <li><a href="#home" onClick={() => scrollToSection('home')}>Početna</a></li>
              <li><a href="#projects" onClick={() => scrollToSection('projects')}>Projekti</a></li>
              <li><a href="#services" onClick={() => scrollToSection('services')}>Usluge</a></li>
